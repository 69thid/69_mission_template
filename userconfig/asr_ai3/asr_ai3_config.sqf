...
asr_ai3_main_sets = [ // for each level: skilltype, [<min value>, <random value added to min>]
	...
	[	'general',[0.90,0.1],	'aiming',[0.60,0.1],	'spotting',[0.70,0.0]	],	// 1:  sf 1
	[	'general',[0.85,0.1],	'aiming',[0.50,0.1],	'spotting',[0.70,0.0]	],	// 2:  sf 2 (recon units, divers and spotters)
	[	'general',[0.80,0.1],	'aiming',[0.35,0.1],	'spotting',[0.60,0.0]	],	// 3:  regular 1 (regular army leaders, marksmen)
	[	'general',[0.75,0.1],	'aiming',[0.30,0.1],	'spotting',[0.50,0.0]	],	// 4:  regular 2 (regulars)
	[	'general',[0.70,0.1],	'aiming',[0.25,0.1],	'spotting',[0.40,0.0]	],	// 5:  militia or trained insurgents, former regulars (insurgent leaders, marksmen)
	[	'general',[0.65,0.1],	'aiming',[0.20,0.1],	'spotting',[0.30,0.0]	],	// 6:  some military training (insurgents)
	[	'general',[0.60,0.1],	'aiming',[0.15,0.1],	'spotting',[0.20,0.0]	],	// 7:  no military training
	[	'general',[0.80,0.1],	'aiming',[0.30,0.1],	'spotting',[0.35,0.0]	],	// 8:  pilot 1 (regular)
	[	'general',[0.75,0.1],	'aiming',[0.25,0.1],	'spotting',[0.30,0.0]	],	// 9:  pilot 2 (insurgent)
	[	'general',[0.90,0.1],	'aiming',[0.80,0.3],	'spotting',[0.90,0.0]	]	// 10: sniper 
];
...
asr_ai3_main_skip_factions = ['CIV_F','CIV_IDAP_F','LOP_AFR_Civ','LOP_CHR_Civ','LOP_TAK_Civ']; // factions added here will not get the AI enhancements
